...
# under the :v0.5.1-rc10 tag, so either default resolves to the same digest
# the operator most recently published.
CUBE_EGRESS_IMAGE_INT_DEFAULT="cube-sandbox-int.tencentcloudcr.com/cube-sandbox/cube-egress:v0.5.1-rc10"
CUBE_EGRESS_IMAGE_CN_DEFAULT="cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-egress:v0.5.1-rc10"
