...
variable "cubemaster_image" {
  ...
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-master:v0.5.1-rc10"
}

variable "cubeapi_image" {
  description = "Full cube-api image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-api:v0.5.1-rc10"
}

variable "cubeproxy_image" {
  description = "Full cube-proxy image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-proxy:v0.5.1-rc10"
}

variable "webui_image" {
  description = "Full webui image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/webui:v0.5.1-rc10"
}

variable "cube_lifecycle_manager_image" {
  description = "Full cube-lifecycle-manager image override."
  type        = string
  default     = "cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-lifecycle-manager:v0.5.1-rc10"
}
