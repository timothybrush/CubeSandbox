...
# to both registries under the same :v0.5.1-rc10 tag; either default resolves
# to whatever the operator most recently published.
CUBE_LCM_IMAGE_INT_DEFAULT="cube-sandbox-int.tencentcloudcr.com/cube-sandbox/cube-lifecycle-manager:v0.5.1-rc10"
CUBE_LCM_IMAGE_CN_DEFAULT="cube-sandbox-cn.tencentcloudcr.com/cube-sandbox/cube-lifecycle-manager:v0.5.1-rc10"
